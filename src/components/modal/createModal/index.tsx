...
const CreateModal = ({
	...
	return (
		<Dialog open={open} onOpenChange={onOpenChange}>
			<DialogContent className="w-full min-w-[768px] bg-card rounded-card max-h-[90vh] flex flex-col border-card backdrop-blur-card p-0">
															...
															{normalizedSeries.map((series) => (
																<li key={series}>
																	<button
																		...
																		className={cn(
																			"w-full text-left px-3 py-2 rounded-card border transition-colors",
																			value.series === series
																				? "bg-theme-primary/10 border-theme-primary text-theme-primary"
																				: "bg-card border-card text-main-text hover:border-theme-primary/50"
																		)}
