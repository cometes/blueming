...
function TabsList({
	...
	return (
		<TabsPrimitive.List
			data-slot="tabs-list"
			className={cn(
				"bg-card-bg border-card text-main-text inline-flex h-9 w-fit items-center justify-center rounded-lg p-[3px] backdrop-blur-sm",
				className
			)}
			{...props}
		/>
