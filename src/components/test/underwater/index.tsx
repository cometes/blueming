  ...
  return (
    <>
      <style jsx global>{`
        ...
        *::after {
        ...
        #caustics::after {
          ...
          width: 100vw;
          height: 100vh;
          background-image: url("/caustic.jpeg");
          background-repeat: repeat;
          --duration: 10s;
          --gapY: 0px;
          background-size: calc(100vw / var(--ratioW)) 30vh;
          animation: caustics calc(var(--duration) * var(--ratioW)) linear
            infinite;
          opacity: 0.3;
          mask-image: linear-gradient(
            to top,
        ...
        .arrows div {
          ...
          border-color: transparent transparent var(--arrowColor)
            var(--arrowColor);
      ...
      <main>
        <section>
          <div>
            <h1>Welcome to the Ocean Effect</h1>
            <h2>Scroll to explore</h2>
            <p>This design creates a dynamic light and water surface effect.</p>
          </div>
        </section>
      </main>
...
export default OceanEffectBackground;
