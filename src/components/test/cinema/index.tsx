  ...
  return (
    <div className="cinema-container">
      <h1 className="cinema-title">
        <span className="cinema-title-span">CSS Cinema Effect</span>
      </h1>
...
export default CSSCinemaEffect;