...
function RaindropComponent() {
  ...
  if (!isMounted) {
    return <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', backgroundColor: '#e5e7eb', zIndex: -1 }} />;
  }
...
export default dynamic(() => Promise.resolve(RaindropComponent), {
  ssr: false,
  loading: () => <div style={{ position: 'fixed', top: 0, left: 0, width: '100vw', height: '100vh', backgroundColor: '#e5e7eb' }} />
});
