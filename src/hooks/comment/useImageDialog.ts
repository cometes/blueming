...
import type { CommentImage } from "./useCommentForm";
import { createImageId } from "./useCommentForm";

const MAX_IMAGE_COUNT = 8;

export const useCommentImageDialog = () => {
	...
	const addImagesToTarget = useCallback(
		(
			setter: React.Dispatch<React.SetStateAction<CommentImage[]>>,
		): boolean => {
