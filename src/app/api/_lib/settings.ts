...
export const normalizeGeneralData = (data: unknown) => {
	...
	const nextGeneral = value.general
		? {
				...
				logoType: mapLogoTypeToKorean((value.general as Record<string, unknown>).logoType as string | undefined),
		  }
		: value.general;
	...
	const nextMenu = value.menu
		? {
				...
				design: mapMenuDesignToKorean((value.menu as Record<string, unknown>).design),
		  }
		: value.menu;
	...
	const normalizedEffect = value.effect
		? {
				...
				type: mapEffectTypeToKorean((value.effect as Record<string, unknown>).type as string | undefined),
		  }
		: undefined;
	...
	const nextDesign = value.design
		? {
				...
				effect: (value.design as Record<string, unknown>).effect
					? {
							...((value.design as Record<string, unknown>).effect as Record<string, unknown>),
							type: mapEffectTypeToKorean(
								((value.design as Record<string, unknown>).effect as Record<string, unknown>).type as string | undefined
							),
					  }
					: normalizedEffect,
		  }
	...
	const nextEffect = normalizedEffect;
